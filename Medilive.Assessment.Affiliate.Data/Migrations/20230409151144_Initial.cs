        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 7L, "AUTHENTICATED_USER", "GetUserSummary", "User", false, "/get-user-summary" },
                    { 8L, "UNAUTHENTICATED_USER", "Login", "Authentication", false, "/user-login" },
                    { 9L, "AUTHENTICATED_USER", "Logout", "Authentication", false, "/user-logout" }
                });
